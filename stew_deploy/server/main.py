...
from server.whatsapp_bot import router as whatsapp_router
...
async def composio_mini_connect(request: Request):
    ...
    try:
        ...
        raise HTTPException(503, f"Cannot verify your app limit right now. Debug: {type(_pw_exc).__name__}: {_pw_exc}") from _pw_exc
    try:
    ...
    if user_text.startswith("/smartclip"):
        ...
        if len(parts) < 2:
            await bot.send_message(chat_id,
                ...
                "Works with: YouTube videos, TikToks, Instagram Reels, X/Twitter, Facebook, and direct .mp4 links\n\n"
                "Usage: /smartclip <url> [num_clips] [duration] [format]\n\n"
                "Examples:\n"
                "1. /smartclip https://youtube.com/watch?v=xxx\n"
                "2. /smartclip https://www.tiktok.com/@user/video/123\n"
                "3. /smartclip https://www.instagram.com/reel/ABC/\n"
                "4. /smartclip https://youtube.com/watch?v=xxx 3 30\n"
                "5. /smartclip https://youtube.com/watch?v=xxx 5 20 wide\n\n"
